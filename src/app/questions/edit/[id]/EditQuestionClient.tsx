...
export default function EditQuestionClient({ questionId }: EditQuestionClientProps) {
                ...
                <Dropdown
                  ...
                  renderOption={(option, isSelected) => (
                    <>
                      <span
                        className={`block truncate ${
                          isSelected ? 'font-medium text-gray-800' : 'font-normal'
                        }`}
                      >
                        {option.label}
                      </span>
                      {option.description && (
                        <span
                          className={`block truncate text-xs mt-0.5 ${
                            isSelected ? 'text-gray-800/70' : 'text-gray-500 dark:text-gray-400'
                          }`}
                        >
                          {option.description}
                        </span>
