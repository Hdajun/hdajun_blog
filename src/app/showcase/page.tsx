...
import { SHOWCASE_LIST, ShowcaseItem, ShowcaseType } from '@/constants/showcase'
...
export default function ShowcasePage() {
  const { isShowcaseItemVisible } = usePermission()

  return (
    <PageGuard pageKey="showcase">
    <div>
      {/* 吸顶页头 */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {SHOWCASE_LIST
          .filter(item => isShowcaseItemVisible(item.id))
          .map((item, i) => (
